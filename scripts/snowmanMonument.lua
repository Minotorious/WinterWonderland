...
winterWonderland:registerAsset({
    ...
    Category = BUILDING_PART_TYPE.EXAMPLE,
    ConstructorData = {
        DataType = "BUILDING_CONSTRUCTOR_DEFAULT",
...
winterWonderland:registerAsset({
    ...
    Category = BUILDING_PART_TYPE.SNOW_BASE,
    ConstructorData = {
        DataType = "BUILDING_CONSTRUCTOR_DEFAULT",
...
winterWonderland:registerAsset({
    ...
    Category = BUILDING_PART_TYPE.SNOWMAN_BASE,
    ConstructorData = {
        DataType = "BUILDING_CONSTRUCTOR_DEFAULT",
...
winterWonderland:registerAsset({
    ...
    Category = BUILDING_PART_TYPE.HAT,
    ConstructorData = {
        DataType = "BUILDING_CONSTRUCTOR_DEFAULT",
...
winterWonderland:registerAsset({
    ...
    Category = BUILDING_PART_TYPE.BUTTON,
    ConstructorData = {
        DataType = "BUILDING_CONSTRUCTOR_DEFAULT",
...
winterWonderland:registerAsset({
    ...
    Category = BUILDING_PART_TYPE.BRANCH_LEFT,
    ConstructorData = {
        DataType = "BUILDING_CONSTRUCTOR_DEFAULT",
...
winterWonderland:registerAsset({
    ...
    Category = BUILDING_PART_TYPE.BRANCH_RIGHT,
    ConstructorData = {
        DataType = "BUILDING_CONSTRUCTOR_DEFAULT",
...
winterWonderland:registerAsset({
    ...
    Material = "MATERIAL_PARTICLE_SMOKE2_GREY",
