...
winterWonderland:registerAsset({
    ...
    Category = BUILDING_PART_TYPE.CHRISTMAS_TREE,
    ConstructorData = {
        DataType = "BUILDING_CONSTRUCTOR_DEFAULT",
...
winterWonderland:registerAsset({
    ...
    Category = BUILDING_PART_TYPE.TOPPER,
    ConstructorData = {
        DataType = "BUILDING_CONSTRUCTOR_DEFAULT",
...
winterWonderland:registerAsset({
    ...
    Category = BUILDING_PART_TYPE.SPHERE_ORNAMENT,
    ConstructorData = {
        DataType = "BUILDING_CONSTRUCTOR_DEFAULT",
...
winterWonderland:registerAsset({
    ...
    Category = BUILDING_PART_TYPE.STAR_ORNAMENT,
    ConstructorData = {
        DataType = "BUILDING_CONSTRUCTOR_DEFAULT",
